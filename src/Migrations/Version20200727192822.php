 ...
 */
final class Version20200727192822 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Lets Pet! 27 July 2020!';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_5A8A6C8DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post_media (post_id VARCHAR(255) NOT NULL, media_id VARCHAR(255) NOT NULL, INDEX IDX_FD372DE34B89032C (post_id), INDEX IDX_FD372DE3EA9FDD75 (media_id), PRIMARY KEY(post_id, media_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post_like (id VARCHAR(255) NOT NULL, post_id VARCHAR(255) DEFAULT NULL, user_id VARCHAR(255) NOT NULL, INDEX IDX_653627B84B89032C (post_id), INDEX IDX_653627B8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id VARCHAR(255) NOT NULL, breeder_id VARCHAR(255) DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, roles JSON NOT NULL, first_name VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, provider VARCHAR(255) DEFAULT NULL, provider_id VARCHAR(255) DEFAULT NULL, provider_last_response LONGTEXT DEFAULT NULL, place_id VARCHAR(255) DEFAULT NULL, last_notification_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649989D9B62 (slug), INDEX IDX_8D93D64933C95BB1 (breeder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pet (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, breeder_id VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, is_alive TINYINT(1) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, gender VARCHAR(255) DEFAULT NULL, breed VARCHAR(255) DEFAULT NULL, about LONGTEXT DEFAULT NULL, is_looking_for_owner TINYINT(1) NOT NULL, date_of_birth DATE DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, eye_color VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, father_name VARCHAR(255) DEFAULT NULL, mother_name VARCHAR(255) DEFAULT NULL, place_id VARCHAR(255) DEFAULT NULL, price VARCHAR(255) DEFAULT NULL, is_free TINYINT(1) DEFAULT NULL, is_sold TINYINT(1) DEFAULT NULL, is_deleted TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_E4529B85989D9B62 (slug), INDEX IDX_E4529B85A76ED395 (user_id), INDEX IDX_E4529B8533C95BB1 (breeder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, public_url VARCHAR(255) NOT NULL, height VARCHAR(255) DEFAULT NULL, width VARCHAR(255) DEFAULT NULL, path VARCHAR(255) DEFAULT NULL, mime VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_6A2CA10CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
